...
GymMane 目前已支持英语、西班牙语、葡萄牙语、意大利语、俄语和简体中文，热烈欢迎社区贡献更多语言。翻译资源位于 [lib/l10n](lib/l10n) 目录下的标准 ARB 文件中 — 每种语言一个独立文件。您可以在 GitHub 上直接编辑对应文件并提交 Pull Request。
